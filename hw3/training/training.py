...
results_fpath = './../results/predict.csv'
save_mean_std = './../model/mean_std.npy'
...
np.save(save_mean_std, np.array([pop_mean, pop_std0, pop_std1]))
print("Save mean and std to {}".format(save_mean_std))
